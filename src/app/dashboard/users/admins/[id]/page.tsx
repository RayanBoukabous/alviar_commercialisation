...
export default function AdminDetailsPage() {
  ...
  useEffect(() => {
    const fetchAdminDetails = async () => {
      if (!adminId) {
        setError('ID d\'administrateur invalide');
        setLoading(false);
        return;
      }
  ...
  const handleEdit = () => {
    ...
    console.log('Éditer l\'admin:', admin);
  };
  ...
  const handleDelete = async () => {
    ...
    const confirmed = window.confirm(
      `Êtes-vous sûr de vouloir supprimer l'administrateur "${admin.fullName}" ?\n\nCette action est irréversible.`
    );
        ...
        <div className="min-h-screen theme-bg-secondary theme-transition">
          <div className="px-6 py-6">
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium mb-2 theme-text-primary theme-transition">Administrateur non trouvé</h3>
              <p className="theme-text-secondary theme-transition">L'administrateur demandé n'existe pas.</p>
            </div>
          </div>
        </div>
      </Layout>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="mt-1 theme-text-secondary theme-transition">Détails de l'administrateur</p>
                </div>
              </div>
                ...
                <div className="p-6">
                  <dl className="grid grid-cols-1 gap-6">
                    ...
                    <div>
                      ...
                      <dd className="mt-1 text-sm theme-text-primary theme-transition">
                        {admin.lastLogout ? formatDate(admin.lastLogout) : 'Jamais déconnecté'}
                      </dd>
                    </div>
                  </dl>
                </div>
