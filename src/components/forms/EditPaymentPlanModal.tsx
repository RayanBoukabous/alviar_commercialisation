...
export const EditPaymentPlanModal: React.FC<EditPaymentPlanModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
  plan,
  ...
  // Charger les données du plan et les options au montage du composant
  useEffect(() => {
    if (isOpen && plan) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updateData: Partial<CreatePaymentPlanRequest> = {
      ...
      await paymentPlansService.updatePaymentPlan(plan.id, updateData);
